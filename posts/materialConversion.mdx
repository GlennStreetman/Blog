...
[Materia UI](https://mui.com/). Material UI offers a wide range of components that promises customization and accessibility out of the box. Material UI is
...
need to pass styling updates down to the child components to get everything to look right. Material UI's [https://mui.com/system/basics/](MUI System) isn’t available in v4 so I was
...
easier said than done. My projects dependency list is getting large at this point and simply trying to 'npm install react@v17' was a no
...
react 17. I then got to go through the joys of having to figure out which of my old projects could easily be upgraded to be compatible with
React 17 and which I might have to deprecate. With much effort I was able to move just about everything over. To finish up I made sure my
project run scripts still worked, everything fired up, and ALL my tests were broken.
...
after meticulously fixing over 60 individual integration tests and tweaking all my backend route tests, I was back up and running. All I had
to do was rebuild my dependency tree, troubleshoot all the resulting dependency problems, figure out how to redo a bunch of frontend
integrations as well as backend route tests, and now I’m ready to find out if the new Material style system is any good.
...
documentation. For example, look at Material's [https://mui.com/guides/testing/](test documentation). To me the documentation feels a bit sparse.
