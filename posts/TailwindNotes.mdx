...
Using Tailwinds, by default, you need to add **dark:** utility class prefixs to [Tailwinds Utility Classes](https://tailwindcss.com/docs/utility-first) in order to specify html element
...
## Next lets extend the [Tailwinds Theme](https://tailwindcss.com/docs/theme). Add the following to your [tailwinds.config file:](https://tailwindcss.com/docs/configuration)
...
accessess the site from the same browser. Note that [Document Element](https://developer.mozilla.org/en-US/docs/Web/API/Document/documentElement) is the root HTML element in the browser. Because the dark or light class
...
## Now lets create the toggle button
...
## Now lets let users perilously define their own colors!
