...
and run my update from dev. No need to jump between terminals or run a build twice. Live and learn. Down the road i will probable contanerize everything and push my changes to docker image hub.
That way my production environment will be able to pull down my working images that contain all of my build files.
