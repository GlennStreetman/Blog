...
Each time an interactive terminal is opened **_source ~/.bashrc_** is automatically executed so all your configurations should be available on the remote machine.
