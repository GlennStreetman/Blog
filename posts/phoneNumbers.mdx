...
I first created three functions. A function to strip all of the user provided formatting out of the phone number. A second function to layer dashes back in as needed. Finaly, a third function
