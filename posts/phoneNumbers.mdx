...
Recently I was building out a service request forms for an automotive website. The form required that i collect user phone numbers. Phone numbers often come with all sorts of clever formatting, 555-555-5555, (555) 555 5555, etc.
...
to check if the phone number is valid. Notice that the regular expressions in stripPhone are far less complex.
