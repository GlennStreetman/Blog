...
libraries like [ExcelJS](https://www.npmjs.com/package/exceljs) and [sheetJS](https://sheetjs.com/) but couldn’t find a free open source library that fit my needs. I could of course use Microsoft{" "}
...
I included [xml2js](https://www.npmjs.com/package/xml2js). The parser would open/read both the source and target files, copy all of the target file XML’s into a working directory,
